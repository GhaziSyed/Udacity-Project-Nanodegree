...
LandingCustomerZone_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://albis-lake-house/customer/landing/"],
        "recurse": True,
    },
...
PrivacyFilter_node1687113604796 = Filter.apply(
    frame=LandingCustomerZone_node1,
    f=lambda row: (not (row["shareWithResearchAsOfDate"] == 0)),
    transformation_ctx="PrivacyFilter_node1687113604796",
)

# Script generated for node Trusted Customer Zone
TrustedCustomerZone_node3 = glueContext.write_dynamic_frame.from_options(
    frame=PrivacyFilter_node1687113604796,
    connection_type="s3",
    format="json",
    connection_options={
        "path": "s3://albis-lake-house/customer/trusted/",
        "partitionKeys": [],
    },
